...
echo "-----------------------"
sed -i 's/numConversionThreads=.*/numConversionThreads=10/g' x
...
cp /root/DevOps-Notebook/Apps/BigBlueButton/Theme/Dei/Whiteboard-DEI.pdf /var/www/bigbluebutton-default/
