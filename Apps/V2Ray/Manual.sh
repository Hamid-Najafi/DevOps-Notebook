...
wget -qO- https://raw.githubusercontent.com/Hamid-Najafi/DevOps-Notebook/master/Apps/V2Ray/AutoInstall/IranClientSetup.sh | bash -s -- -w -a -v focal-250 -s bbb.example.com -e info@example.com
# -------==========-------
