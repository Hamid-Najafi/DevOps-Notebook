...
npm install
nano config.json
  "rtmp_server_url":"http://conf.legace.ir/stat.xml",
  "rtmp_server_stream_url":"rtmp://conf.legace.ir/stream/",
  "rtmp_server_control_url":"http://conf.legace.ir/control",
...
# rtmpdump
# -------==========------- 
rtmpdump -r rtmp://conf.legace.ir/stream/livestream -o rtmpStream.mp4 -v
rtmpdump -r rtmp://conf.legace.ir/stream/livestream -o /dev/null -v
